...
RESOURCES += src/qt/thc.qrc src/qt/thc_locale.qrc

TRANSLATIONS += src/qt/locale/thc_bg.ts \
                src/qt/locale/thc_de.ts \
                src/qt/locale/thc_en.ts \
                src/qt/locale/thc_es.ts \
                src/qt/locale/thc_fi.ts \
                src/qt/locale/thc_fr.ts \
                src/qt/locale/thc_it.ts \
                src/qt/locale/thc_ja.ts \
                src/qt/locale/thc_pl.ts \
                src/qt/locale/thc_pt.ts \
                src/qt/locale/thc_ru.ts \
                src/qt/locale/thc_sk.ts \
                src/qt/locale/thc_sv.ts \
                src/qt/locale/thc_vi.ts \
                src/qt/locale/thc_zh_CN.ts \
                src/qt/locale/thc_zh_TW.ts
