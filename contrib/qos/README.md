...
This means one can have an always-on thcd instance running, and another local thcd/thc-qt instance which connects to this node and receives blocks from it.
