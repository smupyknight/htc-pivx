...
In order to support loading of multiple wallets in thc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is thc.cpp.
...
Changes to thc.cpp
----------------------
thc.cpp is the entry point into thc-qt, and as such, will require some minor modifications to provide hooks for
