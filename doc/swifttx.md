...
This mechanism has been integrated into Bitcore-Node-THC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/THC-Project/insight-api-thc#web-socket-api](https://github.com/THC-Project/insight-api-thc#web-socket-api) 
* API: [https://github.com/THC-Project/insight-api-thc#swifttx-transactions](https://github.com/THC-Project/insight-api-thc#swifttx-transactions) 
...
By default, the THC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the THC Core daemon:
