...
#   c) node1 mines 32 blocks, so now node 0 has 60001thc, node 1 has 4250thc, node2 has none.
#   d) node0 sends 601 thc to node2, in two transactions (301 thc, then 300 thc).
