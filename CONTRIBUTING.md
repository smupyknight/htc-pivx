Contributing to THC Core
============================

The THC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the THC Core project, and is not to be
confused with overall THC Network Protocol consensus changes.

Whether a pull request is merged into THC Core rests with the project merge
...
Patches that change THC consensus rules are considerably more involved than
...
Where a patch set proposes to change the THC consensus, it must have been
...
The project leader is the release manager for each THC Core release.
