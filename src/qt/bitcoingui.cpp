                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("THC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a THC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and thc: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTHC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About THC Core"), this);
    aboutAction->setStatusTip(tr("Show information about THC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for THC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your THC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified THC addresses"));
    ...
    openAction->setStatusTip(tr("Open a THC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the THC Core help message to get a list with possible THC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("THC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to THC network", "", count));
}
...
{
    QString strTitle = tr("THC Core"); // default title
