...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Thc features */
        {"thc", "masternode", &masternode, true, true, false},
        {"thc", "listmasternodes", &listmasternodes, true, true, false},
        {"thc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"thc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"thc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"thc", "masternodedebug", &masternodedebug, true, true, false},
        {"thc", "startmasternode", &startmasternode, true, true, false},
        {"thc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"thc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"thc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"thc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"thc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"thc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"thc", "mnbudget", &mnbudget, true, true, false},
        {"thc", "preparebudget", &preparebudget, true, true, false},
        {"thc", "submitbudget", &submitbudget, true, true, false},
        {"thc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"thc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"thc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"thc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"thc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"thc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"thc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"thc", "checkbudgets", &checkbudgets, true, true, false},
        {"thc", "mnsync", &mnsync, true, true, false},
        {"thc", "spork", &spork, true, true, false},
        {"thc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"thc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use thcd, or the -server option to thc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> thc-cli " + methodname + " " + args + "\n";
}
