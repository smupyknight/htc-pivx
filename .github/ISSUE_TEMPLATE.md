...
This issue tracker is only for technical issues related to THC Core.
General THC questions and/or support requests and are best directed to the [THC Slack](http://thc.slack.com).
...
### What version of THC Core are you using?
